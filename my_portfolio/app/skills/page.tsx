...
const Skills = () => {
  return (
    <div
      className="h-max py-12 scroll-snap w-screen bg-gradient-to-br
    ...
    >
      <section id="skills" className="text-center mx-auto container ">
        ...
        <div
         ...
         mx-auto text-center md:px-12 items-center justify-center ml-7"
        >
          <div
        ...
        from-[#b3d4f5] via-[#ffff] to-[#b3d4f5] ring-1 ring-[#c1c2c2] shadow-black"
          >
            <h2 className="text-2xl font-semibold font-Merienda">CSS</h2>
            <p className="text-md mt-3 font-Merienda">
        ...
        from-[#b3d4f5] via-[#ffff] to-[#b3d4f5] ring-1 ring-[#c1c2c2] shadow-black"
          >
            <h2 className="text-2xl font-semibold font-Merienda">JavaScript</h2>
            <p className="text-md mt-3 font-Merienda">
